...
import { MapPin, Clock, MessageCircle, ShieldCheck, ChevronRight, Globe, Navigation } from 'lucide-react';
...
export default function Footer() {
  ...
  // Coordenadas de ejemplo (Ajusta a tus coordenadas reales si las tienes)
  ...
  const navigationUrl = "https://goo.gl/maps/tuEnlaceDirectoAQUI"; // Cambia esto por tu enlace de "Cómo llegar" de Google Maps

  return (
    // === CONTENEDOR REVEAL (PARALLAX EFFECT) ===
    // El div exterior crea el espacio "falso" en el DOM.
    <div className="relative h-[850px] lg:h-[500px] z-0" style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 100%)" }}>
      
      {/* El footer real se queda pegado al fondo (sticky bottom), creando el efecto de "descubrimiento" */}
      <footer className="fixed bottom-0 left-0 w-full h-[850px] lg:h-[500px] bg-gradient-to-b from-[#0866bd] to-[#043e75] text-white pt-20 pb-8 border-t-[8px] border-[#facc15] flex flex-col justify-end overflow-hidden z-0">
        ...
        <motion.div 
          ...
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: "-100px" }} // Dispara la animación justo antes de verse completo
